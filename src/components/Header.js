    ...
    return (
        <header>
            ...
            <div className="bg-gray-200 flex items-center p-1 justify-center flex-grow mt-2">
                <p className="m-2 w-70 font-serif text-gray-800">Enter an username to get the list of gists</p>
                <input className="h-12 p-1 rounded-full text-center"  
                       placeholder="Enter an username" 
                       onChange={onChangeText}/>
                <FaSearch onClick={onSearchClick} className="cursor-pointer h-10 m-3"/>
            </div>
        </header>
    );
}
